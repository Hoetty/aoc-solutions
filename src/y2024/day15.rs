...
mod tests {
    ...
    fn expected() -> (usize, usize) {
        let file = fs::read_to_string("test-inputs/2024/day15-expect.txt").expect("Expect file missing");
    ...
    #[test]
    fn part1() {
        let result = solve_first(get_input("test-inputs/2024/day15.txt"));
        assert_eq!(result, expected().0);
    }

    #[test]
    fn part2() {
        let result = solve_second(get_input("test-inputs/2024/day15.txt"));
